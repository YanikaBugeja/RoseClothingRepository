...
<body class = "container-fluid">
 ...
 <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <form class="form-inline my-2 my-lg-0" action = "loggedSearch.php" method= "post">
          <input class="form-control mr-sm-2" type="search" placeholder="Searching For ... " id="SearchBarBox" name="searchBar">
...
<?php 
         ...
         if (isset($_POST['SearchBtn'])) {
            ...
            $query = "select * from inventory where InventoryDesc like '%$searchBar%'";
...
<?php
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<div id='sections' class= col-lg-3 col-md-6 col-sm-12' style='margin-top:5%;'> <a href='http://localhost/ProductPage.php?&id=$row[InventoryId]' style='text-decoration:none' >";
                echo "<img style='margin-left: 15%; margin-bottom: 2% ; width: 200px;' src = $row[InventoryImage]>";
                echo "<h4  style = 'color: white; font-family: Courier New, Courier, monospace; text-align: center;'> $row[InventoryDesc] </h4>";
                echo "<h5  style = 'color: white; font-family: Courier New, Courier, monospace; text-align: center;'> &#8364 $row[InventoryPrice]</h5>";
                echo "</div>";
